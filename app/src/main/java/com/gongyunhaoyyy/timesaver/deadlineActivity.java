...
public class deadlineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relativeLayout_deadline = (RelativeLayout) findViewById(R.id.relativeLayout_deadline);
        final View popupWindowView = LayoutInflater.from(mContext).inflate(R.layout.popupwindow_pink,null,false);
